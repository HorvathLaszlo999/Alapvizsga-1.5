...
Belépés engedélyezve.
'''
SIKER = "Sikeres bejelentkezés"
HIBA = "Hibás felhasználónév vagy jelszó"


folytatja = True
while folytatja:
  valasz=input("ird be a Felhasználónevedet: ")
  asd = input("Ird be a jelszavadat: ")
  if valasz == 'bori99' and asd =='Szivecske':
    print(f"engedély megadva, {SIKER}")
    folytatja = False
  elif valasz != 'bori99' and asd !='Szivecske':
    print(f"Engedély megtagadva, {HIBA}")
